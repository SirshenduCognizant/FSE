package com.fsd.assign.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "com.fsd.assign.orm.repository",
...
public class JpaConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
        ...
        factoryBean.setPackagesToScan(new String[] { "com.fsd.assign.model" });
